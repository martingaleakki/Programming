Welcome to the kdb+ Non-Commercial Edition.

kdb+ is Kx Systems flagship product: a unified platform for realtime and historical databases, event processing and general data oriented programming. This release is a full version of kdb+ but is limited to a 32-bit address space, a 4 hour timeout and expiry every 90 days. This software is for non-commercial use only. For commercial use or to upgrade to our production 64-bit software please contact sales@kx.com for information.
...
There is a Google discussion group for users of the non-commercial edition of kdb+ at http://groups.google.com/group/personal-kdbplus.
