...
${OBJECTDIR}/Kalah.o: Kalah.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/Kalah.o Kalah.cpp

${OBJECTDIR}/LuckyTix.o: LuckyTix.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/LuckyTix.o LuckyTix.cpp

${OBJECTDIR}/PisaTowerBalcony.o: PisaTowerBalcony.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/PisaTowerBalcony.o PisaTowerBalcony.cpp

${OBJECTDIR}/PrinceOfPersia.o: PrinceOfPersia.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/PrinceOfPersia.o PrinceOfPersia.cpp

${OBJECTDIR}/PrintNumber.o: PrintNumber.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/PrintNumber.o PrintNumber.cpp

${OBJECTDIR}/RateOfReturn.o: RateOfReturn.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/RateOfReturn.o RateOfReturn.cpp

${OBJECTDIR}/SoldierSpy.o: SoldierSpy.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/SoldierSpy.o SoldierSpy.cpp

${OBJECTDIR}/TimeSeriesDiff.o: TimeSeriesDiff.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/TimeSeriesDiff.o TimeSeriesDiff.cpp
